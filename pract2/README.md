...
Para esta solución, se han de crear dos máquinas virtuales: el servidor web y el servidor de salto, que será a través del cual nos conectaremos al servidor web. Ambas contarán con IP privada y pública. Asimismo, será necesario crear una subred (vpc-prac2) a la cual se conectarán ambos servidores para estar relacionados entre sí. Por otro lado, también será necesario crear tres reglas de firewall para controlar el tráfico entre servidores y con internet. 

- La primera regla permitirá al PC conectarse con la máquina de salto, y comunicarse a través del puerto TCP 22.
- La segunda regla hará referencia a la comunicación del servidor web por los puertos 80 y 443, con el PC. 
- La tercera regla, deberá permitir el tráfico del servidor de salto al servidor web,a través del puerto 22. 
